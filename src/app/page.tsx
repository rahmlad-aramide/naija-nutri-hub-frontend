  ...
  return (
    <div className="flex flex-col items-center justify-around min-h-screen background text-foreground">
      ...
      <div className="relative w-full max-w-xs mx-auto px-5">
        <div
          ref={ScrollRef}
          className="flex items-center space-x-3 overflow-x-auto scrollbar-hide scroll-smooth whitespace-nowrap pr-10"
        >
        ...
        <button
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 bg-[#282828] text-gray-300 hover:text-white p-1 rounded-full"
